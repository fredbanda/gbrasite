...
import { TbArrowUpRight, TbCoins } from "react-icons/tb";
...
export default function Navigation() {
    ...
    return (
        <>
            ...
            <div>
            <Link href="/contact" className="items-center hidden px-5 py-2 font-medium text-gray-800 bg-yellow-200 mr-3 border border-gray-600 rounded-full shadow lg:inline-flex hover:bg-green-500 hover:text-white">
                Donate To Causes <TbCoins className="w-5 h-5 ml-2" />
            </Link>
