        ...
        <div className="bg-zinc-100">
            <div className="container lg:grid lg:grid-cols-2 py-14">
                <div className="grid gap-4 pb-4 text-left lg:pb-0 lg:grid-cols-3">
                    <div>
                        <h2 className="pb-4 text-xl font-semibold">ASSOCIATION</h2>
                    ...
                    <div>
                        <h2 className="pb-4 text-xl font-semibold">WHAT WE DO</h2>
                        <div className="flex flex-col ">
                            <Link className="py-1 hover:underline" href="/about">About Us</Link>
                            <Link className="py-1 hover:underline" href="/api-doc">API Reference</Link>
                            <Link className="py-1 hover:underline" href="/careers">Careers</Link>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col ">
                            <Link className="py-1 hover:underline" href="/instagram">Instagram</Link>
                            <Link className="py-1 hover:underline" href="/linkedin">Linkedin</Link>
                            <Link className="py-1 hover:underline" href="/twitter">X (Twittter)</Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="py-10 bg-zinc-200">
                <div className="container text-center text-gray-500 lg:justify-between lg:flex">
                    <div className="pb-4 lg:pb-0">
                        <p>&copy;2020 - {currentYear} GBRA.All rights reserved </p>
                    </div>
                    <p className="italic text-sm ">by The First Pitch Group with <Link href="ttps://wa.me/27814402910"><span className="text-red-500">❤</span></Link></p>
                    <div className="">
